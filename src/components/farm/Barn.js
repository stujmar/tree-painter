...
const Barn = () => {
    ...
    const handleBarnClick = () => {
        console.log("barn clicked");
    }

    return (
        <div className="absolute bottom-0 left-0 z-10">
            <button type="button" onClick={handleBarnClick} className={`block focus:outline-none${isActive ? " transition duration-2000" : ""}`} style={barnStyle}>  
