            ...
            <div className="w-4 h-2 bg-orange-400 mx-auto opacity-100 text-green-100 relative">
              {trunkData.left ? <div style={{width: trunkData.left*3, zIndex: 0,  transform: "rotate(20deg)"}}className="h-1 bg-orange-400 absolute top-1 right-3">
                  <div className="relative w-full h-full">
                    <div style={{height:  returnBranchWidth(trunkData.left), width: returnBranchWidth(trunkData.left), top: -trunkData.right}} className="h-3 w-3 bg-green-300 absolute rounded-full -left-2"></div>
                  </div>
              </div> : null}
              {trunkData.right ? <div style={{width: trunkData.right*3, zIndex: 0, transform: "rotate(-20deg)"}}className="h-1 bg-orange-400 absolute top-1 left-3">
                <div className="relative w-full h-full">
                    <div style={{height: returnBranchWidth(trunkData.right), width: returnBranchWidth(trunkData.right), top: -trunkData.right}} className="h-3 w-3 bg-green-300 absolute rounded-full  -right-2"></div>
                  </div>
              </div> : null}
            </div>
