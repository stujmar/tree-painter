...
const Trunk = ({trunkData, color, girth}) => {
    ...
    return (
            ...
            <div style={{width: girth}} className="h-2 bg-orange-400 opacity-100 text-green-100 relative">
              {trunkData.left ? <div style={{width: trunkData.left*3, zIndex: 0,  transform: "rotate(20deg)", right: girth - 2 }}className="h-1 bg-orange-400 absolute top-1">
              ...
              {trunkData.right ? <div style={{width: trunkData.right*3, zIndex: 0, transform: "rotate(-20deg)", left: girth - 2}}className="h-1 bg-orange-400 absolute top-1">
                <div className="relative w-full h-full">
