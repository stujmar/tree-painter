...
<circle r="1.5" transform="matrix(1 0 0 -1 18.5 22.5)" fill="#C4C4C4"/>
    ...
    <path d="M12.7565 7.60574C13.5269 6.79813 14 5.70432 14 4.5C14 2.01471 11.9853 0 9.5 0C7.01471 0 5 2.01471 5 4.5C5 6.16299 5.90204 7.61526 7.24353 8.39426C6.5249 9.14749 6.06506 10.1497 6.00641 11.2583C5.53546 11.0911 5.02832 11 4.5 11C2.01471 11 0 13.0147 0 15.5C0 17.9853 2.01471 20 4.5 20C6.90424 20 8.86804 18.1146 8.99359 15.7417C9.46454 15.9089 9.97168 16 10.5 16C11.0854 16 11.6446 15.8882 12.1576 15.6849C12.6777 17.5953 14.4248 19 16.5 19C18.9853 19 21 16.9853 21 14.5C21 13.0503 20.3145 11.7608 19.25 10.9378C21.3783 10.5807 23 8.72977 23 6.5C23 4.01471 20.9853 2 18.5 2C16.0147 2 14 4.01471 14 6.5C14 7.94968 14.6855 9.23923 15.75 10.0622C15.4352 10.1151 15.1314 10.2005 14.8423 10.3151C14.5284 9.16171 13.7672 8.19263 12.7565 7.60574Z" fill="#C4C4C4"/>
    <path d="M16 22.5C16 24.9853 13.9853 27 11.5 27C9.01471 27 7 24.9853 7 22.5C7 20.0147 9.01471 18 11.5 18C13.9853 18 16 20.0147 16 22.5Z" fill="#C4C4C4"/>
    ...
    <path d="M5.5 23C6.32843 23 7 23.6716 7 24.5C7 25.3284 6.32843 26 5.5 26C4.67157 26 4 25.3284 4 24.5C4 23.6716 4.67157 23 5.5 23Z" fill="#C4C4C4"/>
    ...
    <path d="M17.5 19C18.3284 19 19 19.6716 19 20.5C19 21.3284 18.3284 22 17.5 22C16.6716 22 16 21.3284 16 20.5C16 19.6716 16.6716 19 17.5 19Z" fill="#C4C4C4"/>
    </svg> : null }
    </div>
    </button>
  )
