...
const Gnome = ({data}) => {
  ...
  return (
    ...
    style={{
        ...
        top: `${data.y -3}%`, 
        width: "20px",
        overflow: data.age === 6 ? "visible" : "hidden",
        height: "40px",
        }}
    >
    <div className="relative">

    {data.age < 6 ? <svg className="absolute" style={{top: `-${data.age*3.5}px`}} width="21" height="40" viewBox="0 0 21 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<circle r="1.5" transform="matrix(1 0 0 -1 18.5 22.5)" fill="#C4C4C4"/>
    ...
    {data.age === 5 ? <svg className="absolute" width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
